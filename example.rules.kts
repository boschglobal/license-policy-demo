 ...
 * This is a kotlin script that provides an example of rules for the evaluator in OSS Review Toolkit.
 * It is not intended to any particular use case, other than demonstration, and it is provided as is
 * pursuant to the applicable Apache-2.0 license.
 */
...
val ruleSet = ruleSet(ortResult, licenseInfoResolver) {
    packageRule("Packages") {
        ...
        licenseRule("Unchecked license", LicenseView.CONCLUDED_OR_DECLARED_AND_DETECTED) {
            ...
            val howToFixMessage = """
                |This license needs to be checked and classified. Please contact info@example.org.
            """.trimMargin()
        ...
        /**
         * Deny strong copyleft licenses for all packages in distributed products.
         */
